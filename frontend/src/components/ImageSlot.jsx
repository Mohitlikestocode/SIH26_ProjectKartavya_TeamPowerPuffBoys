...
// (dashed ring, icon, caption) so the layout matches; add a real <img src>
// here once photos are available.
export default function ImageSlot({ shape = "rounded", radius = 12, style, placeholder = "Drop an image" }) {
  const shapeStyle =
