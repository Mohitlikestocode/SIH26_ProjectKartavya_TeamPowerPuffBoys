  ...
  return (
    <div role="dialog" aria-label="AI assistant" style={css("position:fixed; right:20px; bottom:20px; width:min(94vw,400px); max-height:min(78vh,620px); background:#fff; border:1px solid #C9CFD8; box-shadow:0 12px 40px rgba(10,34,64,0.25); z-index:70; display:flex; flex-direction:column; border-radius:4px")}>
      ...
      <div style={css("padding:12px 14px; border-top:1px solid #DDE1E7; display:flex; gap:9px; align-items:center")}>
        <input type="text" placeholder="Ask in English or हिंदी…" style={css("flex:1; min-width:0; font:inherit; font-size:14px; padding:11px 12px; border:1px solid #C9CFD8; border-radius:8px")} />
        <button aria-label="Speak your question" style={css("font:inherit; font-size:13px; font-weight:700; cursor:pointer; padding:11px 13px; border:1px solid #C9CFD8; background:#fff; color:#123E7C; border-radius:8px")}>Voice</button>
        <button style={css("font:inherit; font-size:13px; font-weight:700; cursor:pointer; padding:11px 15px; border:0; background:#123E7C; color:#fff; border-radius:8px")}>Send</button>
      </div>
    </div>
  );
}
