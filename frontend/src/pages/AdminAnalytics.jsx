  ...
  return (
    <section style={css("padding:24px 0 0")}>
      <div style={css("display:flex; justify-content:space-between; align-items:flex-end; gap:20px; flex-wrap:wrap; margin-bottom:16px")}>
        <div>
          <h1 style={css("font-family:'Poppins',sans-serif; font-size:28px; font-weight:700; color:#123E7C; margin:0")}>Competency heatmap — Official Statistical System</h1>
      ...
      <div style={css("background:#fff; border:1px solid #E3E9F2; padding:12px 18px; display:flex; gap:18px; align-items:center; flex-wrap:wrap; margin-bottom:20px")}>
        <span style={css("font-size:10.5px; font-weight:700; letter-spacing:0.09em; text-transform:uppercase; color:#7A8492")}>Cohort</span>
        <div style={css("display:flex; gap:8px; align-items:center")}><span style={css("font-size:12.5px; color:#5A6472")}>Region</span><span style={css("font-size:13px; font-weight:600; color:#123E7C; border:1px solid #C9CFD8; padding:5px 10px; background:#FBFCFD")}>All India ▾</span></div>
        <div style={css("display:flex; gap:8px; align-items:center")}><span style={css("font-size:12.5px; color:#5A6472")}>Cadre</span><span style={css("font-size:13px; font-weight:600; color:#123E7C; border:1px solid #C9CFD8; padding:5px 10px; background:#FBFCFD")}>All cadres ▾</span></div>
        <div style={css("display:flex; gap:8px; align-items:center")}><span style={css("font-size:12.5px; color:#5A6472")}>Assessed</span><span style={css("font-size:13px; font-weight:600; color:#123E7C; border:1px solid #C9CFD8; padding:5px 10px; background:#FBFCFD")}>Last 12 months ▾</span></div>
        <span style={css("margin-left:auto; font-size:12px; color:#7A8492")}>Data as on 31 Aug 2026</span>
      </div>
      <div style={css("display:grid; grid-template-columns:repeat(auto-fit,minmax(min(100%,400px),1fr)); gap:20px; align-items:start")}>
        <div style={css("background:#fff; border:1px solid #E3E9F2; padding:22px 24px; min-width:0")}>
          <div style={css("display:flex; justify-content:space-between; align-items:baseline; gap:12px; margin-bottom:16px; flex-wrap:wrap")}>
            <h2 style={css("font-family:'Poppins',sans-serif; font-size:20px; font-weight:700; color:#123E7C; margin:0")}>Cadre × domain gap severity</h2>
          ...
          <div style={css("overflow-x:auto")}>
            <div style={css("min-width:520px; display:grid; grid-template-columns:minmax(140px,190px) repeat(4,minmax(62px,1fr)); gap:1px; background:#E4E7EC; border:1px solid #E4E7EC")}>
              ...
              <div style={css("background:#F7F8FA; padding:11px 6px; text-align:center; font-size:11.5px; font-weight:700; color:#1B5CB8")}>Statistical</div>
              <div style={css("background:#F7F8FA; padding:11px 6px; text-align:center; font-size:11.5px; font-weight:700; color:#0F766E")}>Technical</div>
              <div style={css("background:#F7F8FA; padding:11px 6px; text-align:center; font-size:11.5px; font-weight:700; color:#9D2449")}>Digital Gov.</div>
        ...
        <div style={css("display:grid; gap:20px; min-width:0")}>
          <div style={css("background:#fff; border:1px solid #E3E9F2; border-radius:12px; padding:22px 24px")}>
            <h2 style={css("font-family:'Poppins',sans-serif; font-size:20px; font-weight:700; color:#123E7C; margin:0 0 3px")}>Training effectiveness</h2>
          ...
          <div style={css("background:#fff; border:1px solid #E3E9F2; border-radius:12px; padding:22px 24px")}>
            <div style={css("display:flex; justify-content:space-between; align-items:baseline; gap:10px; flex-wrap:wrap")}>
              <h2 style={css("font-family:'Poppins',sans-serif; font-size:20px; font-weight:700; color:#123E7C; margin:0 0 3px")}>Emerging skill requirements</h2>
            ...
            {v.emerging.map((m, i) => (
              <div key={i} style={css("display:grid; grid-template-columns:1fr auto auto; gap:12px; align-items:center; padding:10px 0; border-bottom:1px solid #EEF0F3")}>
                ...
                <span style={css(`font-size:10.5px; font-weight:700; padding:3px 7px; border-radius:6px; color:${m.color}; background:${m.tint}; border:1px solid ${m.border}; white-space:nowrap`)}>{m.domain}</span>
